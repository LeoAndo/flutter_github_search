...
abstract class _$$DataCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<RepositorySummary> repositories});
}
...
class _$Data with DiagnosticableTreeMixin implements Data {
  const _$Data(final List<RepositorySummary> repositories)
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UiState.data(repositories: $repositories)';
  }
...
abstract class Data implements UiState {
  const factory Data(final List<RepositorySummary> repositories) = _$Data;
