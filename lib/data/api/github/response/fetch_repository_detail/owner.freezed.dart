...
abstract class $OwnerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String avatarUrl, int id, String nodeId});
}
...
class _$_Owner with DiagnosticableTreeMixin implements _Owner {
  const _$_Owner(
      {required this.avatarUrl, required this.id, required this.nodeId});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Owner(avatarUrl: $avatarUrl, id: $id, nodeId: $nodeId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, avatarUrl, id, nodeId);
...
abstract class _Owner implements Owner {
  const factory _Owner(
      ...
      required final String nodeId}) = _$_Owner;
